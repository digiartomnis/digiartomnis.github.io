...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    if (_e168 < 0f) {
        ...
        let _e227 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e179, v_5, iblRoughness, _e180, in_1.worldPos, vec3<f32>(_e184, _e187, _e190), _e194.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1, skylightPrefilterMap, _e203, _e206.xyz, max((-(_e210) - 1f), 0f), (_e219 > 0.5f));
        specularIbl = _e227;
    } else {
    ...
    let _e299 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.worldPos, _e296, ssaoBlurredTexture, ssaoBlurredSampler);
    ambient = (_e292 * _e299);
    let _e301 = ambient;
    color = _e301;
    ...
    let _e488 = standardViewZ(in_1);
    let _e489 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e486, in_1.worldPos, _e488);
    ...
    let _e512 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e489 * _e493), in_1.worldPos, _e499.xyz, _e503.xyz, _e507.xyz, _e511);
    color = (_e494 + _e512);
    let _e514 = color;
    let _e517 = standardViewZ(in_1);
    let _e519 = physicalNormal;
    let _e520 = diffuseAlbedo;
    let _e521 = f0_;
    let _e524 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e517, in_1.worldPos, _e519, v_5, _e520, metallic_11, a_3, _e521, false, true);
    color = (_e514 + _e524);
    let _e526 = color;
