...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e352 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e348, (_e349 * skyFactor), probeDiffuseK, _e351, metallic_13);
    if true {
    ...
    let _e564 = f0_;
    let _e565 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e562, v_5, _e563, metallic_13, a_3, _e564);
    let _e566 = color;
    ...
    let _e593 = f0_;
    let _e596 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e589, in_1.worldPos, _e591, v_5, _e592, metallic_13, a_3, _e593, false, true);
    color = (_e586 + _e596);
    let _e598 = color;
