...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e374 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e370, (_e371 * skyFactor), probeDiffuseK, _e373, metallic_12);
    ...
    let _e585 = f0_;
    let _e586 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e583, v_2, _e584, metallic_12, a_2, _e585);
    let _e587 = color;
    ...
    let _e614 = f0_;
    let _e617 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e610, in_2.worldPos, _e612, v_2, _e613, metallic_12, a_2, _e614, false, true);
    color = (_e607 + _e617);
    let _e619 = color;
