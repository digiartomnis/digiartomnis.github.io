...
fn evaluate_standard_surface(input_2: SurfaceInput, materialValue: MaterialParameters) -> SurfaceData {
    ...
    normal_12 = normalize(input_2.geometricNormalWS);
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let metallic_4 = clamp(_e14, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e55) * _e57), albedo_2, metallic_4);
    physicalNormal = n;
    ...
    let kD_1 = ((vec3(1f) - _e70) * (1f - metallic_4));
    ...
    let _e288 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e284, (_e285 * skyFactor), probeDiffuseK, _e287, metallic_4);
    ...
    color = _e299;
    let _e301 = color;
    color = (_e301 + _e9.emissive);
    let _e304 = physicalNormal;
    let _e306 = standardViewZ(in_2);
    let _e307 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e304, in_2.worldPos, _e306);
    let _e308 = physicalNormal;
    let _e309 = diffuseAlbedo;
    let _e310 = f0_;
    let _e311 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e308, v, _e309, metallic_4, a_2, _e310);
    let _e312 = color;
    let _e317 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e321 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e325 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e329 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e330 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e307 * _e311), in_2.worldPos, _e317.xyz, _e321.xyz, _e325.xyz, _e329);
    color = (_e312 + _e330);
    let _e332 = color;
    return vec4<f32>(_e332, alpha);
}
