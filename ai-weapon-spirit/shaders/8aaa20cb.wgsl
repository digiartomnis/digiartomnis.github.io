...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let metallic_12 = clamp(_e14, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e55) * _e57), albedo_2, metallic_12);
    physicalNormal = n_2;
    ...
    let kD_1 = ((vec3(1f) - _e70) * (1f - metallic_12));
    ...
    let _e288 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e284, (_e285 * skyFactor), probeDiffuseK, _e287, metallic_12);
    ...
    let _e319 = f0_;
    let _e320 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e317, v_2, _e318, metallic_12, a_2, _e319);
    let _e321 = color;
    ...
    let _e348 = f0_;
    let _e351 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e344, in_2.worldPos, _e346, v_2, _e347, metallic_12, a_2, _e348, false, true);
    color = (_e341 + _e351);
    let _e353 = color;
