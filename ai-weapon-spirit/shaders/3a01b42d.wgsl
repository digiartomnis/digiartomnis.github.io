...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e54 = f0_;
    let _e55 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e50, v_2), 0f), _e54, iblRoughness);
    ...
    if (_e67 < 0f) {
        ...
        let _e144 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e135, v_2, iblRoughness, _e136, _e139, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e144;
    }
    ...
    let _e258 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e254, (_e255 * skyFactor), probeDiffuseK, _e257, metallic_13);
    if true {
    ...
    let _e292 = f0_;
    let _e293 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e290, v_2, _e291, metallic_13, a_3, _e292);
    let _e294 = color;
    ...
    let _e321 = f0_;
    let _e324 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e317, in_1.worldPos, _e319, v_2, _e320, metallic_13, a_3, _e321, false, true);
    color = (_e314 + _e324);
    let _e326 = color;
