...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e279 = ambient;
    ambient = (_e279 * ao);
    let _e281 = reflectionFallback;
    reflectionFallback = ((_e281 * _e256) * ao);
    let _e284 = ambient;
    color = _e284;
    ...
    let _e357 = material.thickness;
    let _e359 = finiteScalar(_e357, 0f);
    let _e362 = thicknessSample;
    let _e364 = finiteScalar(_e362, 1f);
    let worldThickness = max(((_e359 * length(worldRefractedDirection)) * _e364), 0f);
    ...
    let _e406 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e406.xyz;
    ...
    let _e414 = local_1;
    if _e414 {
        let _e422 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e422.xyz;
    }
    let _e426 = material.attenuationColor;
    let _e429 = finiteColor(_e426, vec3(1f));
    let safeAttenuationColor = clamp(_e429, vec3(0f), vec3(1f));
    let _e437 = material.attenuationDistance;
    let _e439 = finiteScalar(_e437, 0f);
    let safeAttenuationDistance = max(_e439, 0f);
    ...
    let _e456 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e456);
    let _e458 = color;
    let _e459 = transmittedBackdrop;
    let _e462 = finiteColor(_e459, vec3(0f));
    color = (_e458 + ((_e462 * transmittedEnergy) * beerAttenuation));
    let _e466 = physicalNormal;
    let _e468 = standardViewZ(in_2);
    let _e469 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e466, in_2.worldPos, _e468);
    let _e470 = physicalNormal;
    let _e471 = diffuseAlbedo;
    let _e472 = f0_;
    let _e473 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e470, v, _e471, metallic_5, a_3, _e472);
    let _e474 = color;
    let _e479 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e483 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e487 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e491 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e492 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e469 * _e473), in_2.worldPos, _e479.xyz, _e483.xyz, _e487.xyz, _e491);
    color = (_e474 + _e492);
    let _e494 = color;
    color = (_e494 + _e7.emissive);
    let _e499 = color;
    output.color = vec4<f32>(_e499, alpha_1);
    let _e502 = reflectionFallback;
    let _e503 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e502, _e503);
    let _e505 = output;
    return _e505;
}
