...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e54 = f0_;
    let _e55 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e50, v), 0f), _e54, iblRoughness);
    ...
    if (_e67 < 0f) {
        ...
        let _e144 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e135, v, iblRoughness, _e136, _e139, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e144;
    }
    ...
    let _e258 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e254, (_e255 * skyFactor), probeDiffuseK, _e257, metallic_5);
    if true {
    ...
    let _e273 = ambient;
    color = _e273;
    let _e275 = physicalNormal;
    let _e277 = standardViewZ(in_1);
    let _e278 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e275, in_1.worldPos, _e277);
    let _e279 = physicalNormal;
    let _e280 = diffuseAlbedo;
    let _e281 = f0_;
    let _e282 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e279, v, _e280, metallic_5, a_3, _e281);
    let _e283 = color;
    let _e288 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e292 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e296 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e300 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e301 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e278 * _e282), in_1.worldPos, _e288.xyz, _e292.xyz, _e296.xyz, _e300);
    color = (_e283 + _e301);
    let _e303 = color;
    color = (_e303 + _e6.emissive);
    let _e308 = color;
    output.color = vec4<f32>(_e308, alpha_1);
    let _e311 = reflectionFallback;
    let _e312 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e311, _e312);
    let _e314 = output;
    return _e314;
}
