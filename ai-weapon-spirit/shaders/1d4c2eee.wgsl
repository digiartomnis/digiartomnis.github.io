...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_2: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_2.x == worldPosition_2.x) {
        local_8 = (worldPosition_2.y == worldPosition_2.y);
    } else {
        local_8 = false;
    }
    let _e10 = local_8;
    if _e10 {
        local_9 = (worldPosition_2.z == worldPosition_2.z);
    } else {
        local_9 = false;
    }
    let _e17 = local_9;
    if _e17 {
        local_10 = all((abs(worldPosition_2) < vec3(3.402823e38f)));
    } else {
        local_10 = false;
    }
