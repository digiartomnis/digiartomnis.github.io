...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e290 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.worldPos, _e287, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e291 = ambient;
    ambient = (_e291 * _e290);
    ...
    color = (_e485 + _e503);
    let _e505 = color;
    let _e508 = standardViewZ(in_1);
    let _e510 = physicalNormal;
    let _e511 = diffuseAlbedo;
    let _e512 = f0_;
    let _e515 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e508, in_1.worldPos, _e510, v_2, _e511, metallic_13, a_3, _e512, false, true);
    color = (_e505 + _e515);
    let _e517 = color;
