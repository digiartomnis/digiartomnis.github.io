...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e365 = material.thickness;
    let _e367 = finiteScalar(_e365, 0f);
    let _e370 = thicknessSample;
    let _e372 = finiteScalar(_e370, 1f);
    let worldThickness = max(((_e367 * length(worldRefractedDirection)) * _e372), 0f);
    ...
    let _e483 = f0_;
    let _e484 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e481, v, _e482, metallic_2, a_2, _e483);
    let _e485 = color;
    let _e490 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e494 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e498 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e502 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e503 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e480 * _e484), in_2.worldPos, _e490.xyz, _e494.xyz, _e498.xyz, _e502);
    color = (_e485 + _e503);
    let _e505 = color;
    return vec4<f32>(_e505, alpha);
}
