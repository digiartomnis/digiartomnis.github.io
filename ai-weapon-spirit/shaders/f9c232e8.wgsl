...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e512 = f0_;
    let _e515 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e508, in_1.worldPos, _e510, v_5, _e511, metallic_14, a_4, _e512, false, true);
    color = (_e505 + _e515);
    let _e517 = color;
