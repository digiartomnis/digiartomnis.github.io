...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e521 = f0_;
    let _e524 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e517, in_1.worldPos, _e519, v_2, _e520, metallic_10, a_2, _e521, false, true);
    color = (_e514 + _e524);
    let _e526 = color;
