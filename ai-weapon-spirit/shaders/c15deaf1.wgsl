...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e287 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e290 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.worldPos, _e287, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e291 = ambient;
    ambient = (_e291 * _e290);
    let _e293 = reflectionFallback;
    reflectionFallback = (_e293 * _e290);
    let _e295 = ambient;
    color = _e295;
    ...
    let _e483 = f0_;
    let _e484 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e481, v_2, _e482, metallic_13, a_3, _e483);
    let _e485 = color;
    ...
    let _e512 = f0_;
    let _e515 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e508, in_2.worldPos, _e510, v_2, _e511, metallic_13, a_3, _e512, false, true);
    color = (_e505 + _e515);
    let _e517 = color;
    color = (_e517 + _e7.emissive);
    let _e522 = color;
    output.color = vec4<f32>(_e522, alpha_1);
    let _e525 = reflectionFallback;
    let _e526 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e525, _e526);
    let _e528 = output;
    return _e528;
}
