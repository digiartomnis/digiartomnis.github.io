...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    reflectionFallback = ((_e198 * _e173) * ao);
    let _e204 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e207 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.worldPos, _e204, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e208 = ambient;
    ambient = (_e208 * _e207);
    let _e210 = reflectionFallback;
    reflectionFallback = (_e210 * _e207);
    let _e212 = ambient;
    color = _e212;
    ...
    let _e220 = f0_;
    let _e221 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e218, v_5, _e219, metallic_14, a_4, _e220);
    let _e222 = color;
    ...
    color = (_e222 + _e240);
    let _e242 = color;
    let _e245 = standardViewZ(in_1);
    let _e247 = physicalNormal;
    let _e248 = diffuseAlbedo;
    let _e249 = f0_;
    let _e252 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e245, in_1.worldPos, _e247, v_5, _e248, metallic_14, a_4, _e249, false, true);
    color = (_e242 + _e252);
    let _e254 = color;
    color = (_e254 + _e6.emissive);
    let _e259 = color;
    output.color = vec4<f32>(_e259, alpha_1);
    let _e262 = reflectionFallback;
    let _e263 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e262, _e263);
    let _e265 = output;
    return _e265;
}
