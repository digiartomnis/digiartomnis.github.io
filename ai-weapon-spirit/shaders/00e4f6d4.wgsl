...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e341 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e337, (_e338 * skyFactor), probeDiffuseK, _e340, metallic_14);
    if true {
    ...
    let _e555 = f0_;
    let _e556 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e553, v_5, _e554, metallic_14, a_4, _e555);
    let _e557 = color;
    ...
    let _e584 = f0_;
    let _e587 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e580, in_1.worldPos, _e582, v_5, _e583, metallic_14, a_4, _e584, false, true);
    color = (_e577 + _e587);
    let _e589 = color;
...
fn fs_gbuffer(in_2: VsOut, @builtin(front_facing) frontFacing_1: bool) -> GBufferOutput {
    ...
    let _e35 = projectSpecularRadianceX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(vec3(1f), n_6, normalize((_e28 - in_2.worldPos)), roughness_10, _e32, brdfLut_3, irradianceSampler_1);
