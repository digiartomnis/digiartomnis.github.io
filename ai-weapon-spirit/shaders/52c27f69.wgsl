...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_10: vec3<f32>, viewDir_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_9: f32, alphaSq_7: f32, F0_12: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_5 = max(dot(normal_10, l_5), 0f);
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_3: u32, normal_11: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    var local_18: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_14: vec3<f32>, layer_4: u32, count_4: u32, normal_12: vec3<f32>, l_1: vec3<f32>) -> f32 {
    var local_19: bool;
    var local_20: bool;
    var local_21: bool;
    var local_22: bool;
    ...
    let _e102 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4, normal_12, l_1, f32(((kernel / 2u) + 1u)));
    ...
    if (kernel == 3u) {
        if all((uv_5 >= (tileLo + texel_2))) {
            local_23 = all((uv_5 <= (tileHi - texel_2)));
        } else {
            local_23 = false;
        }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_13: vec3<f32>, worldPos_15: vec3<f32>, viewZ: f32) -> f32 {
    ...
    let receiverPosition = (worldPos_15 + (normal_13 * _e33));
    let _e36 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, _e28, count_5, normal_13, l_6);
    shadow_1 = _e36;
    ...
    if _e49 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e72 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, (_e28 + 1u), count_5, normal_13, l_6);
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_25 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_25 = false;
    }
    let _e10 = local_25;
    if _e10 {
        local_26 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_26 = false;
    }
    let _e17 = local_26;
    if _e17 {
        local_27 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_27 = false;
    }
    let validReceiver = local_27;
    ...
    if all((uv_6 >= vec2(0f))) {
        local_28 = all((uv_6 <= vec2(1f)));
    } else {
        local_28 = false;
    }
    let inRange = local_28;
    if (shadowProjection.y > 0.5f) {
        local_29 = (shadowProjection.z < 0.5f);
    } else {
        local_29 = false;
    }
    let _e64 = local_29;
    if _e64 {
        local_30 = (shadowProjection.x > 0f);
    } else {
        local_30 = false;
    }
    let available = local_30;
