...
fn vs_main(native: NativeInput, @builtin(vertex_index) vertex: u32) -> Varying {
    ...
    let _e196 = size;
    let plane = vec3<f32>(((c_1 + _e193.zw) * _e196), 0f);
    ...
    let _e214 = right;
    let _e217 = up;
    let _e227 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.settings.w;
    ...
    input.normal = normal;
    let _e241 = world;
    input.worldPosition = _e241;
    let _e245 = frame.eye;
    let _e247 = world;
    input.viewDirection = (_e245.xyz - _e247);
    let _e253 = frame.settings.x;
    input.time = _e253;
    input.delta = 0.008333334f;
    let _e256 = input;
    let _e257 = source_vertex(_e256);
    let _e259 = p.age;
    let _e260 = magic_placeX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e257, _e259);
    let _e263 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.anchor;
    world = (_e260 + _e263.xyz);
    let _e270 = frame.vp;
    let _e271 = world;
    o.position = (_e270 * vec4<f32>(_e271, 1f));
    o.uv = _e190.uv0_;
    o.custom = _e190.uv1_;
    let _e281 = p.color;
    o.color = _e281;
    let _e283 = world;
    o.world = _e283;
    let _e287 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e291 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e295 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.normal = normalize((mat3x3<f32>(_e287.xyz, _e291.xyz, _e295.xyz) * normal));
    let _e300 = o;
    return _e300;
}
