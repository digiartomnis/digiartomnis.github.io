...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e468 = standardViewZ(in_1);
    let _e469 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e466, in_1.worldPos, _e468);
    ...
    let _e492 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e469 * _e473), in_1.worldPos, _e479.xyz, _e483.xyz, _e487.xyz, _e491);
    color = (_e474 + _e492);
    let _e494 = color;
