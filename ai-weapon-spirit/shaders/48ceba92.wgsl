...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e269 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e265, (_e266 * skyFactor), probeDiffuseK, _e268, metallic_13);
    if true {
    ...
    let _e301 = f0_;
    let _e302 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e299, v_5, _e300, metallic_13, a_3, _e301);
    let _e303 = color;
    ...
    let _e330 = f0_;
    let _e333 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e326, in_1.worldPos, _e328, v_5, _e329, metallic_13, a_3, _e330, false, true);
    color = (_e323 + _e333);
    let _e335 = color;
