...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e72 = f0_;
    let _e73 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e68, v_2), 0f), _e72, iblRoughness);
    ...
    if (_e85 < 0f) {
        ...
        let _e162 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e153, v_2, iblRoughness, _e154, _e157, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e162;
    }
    ...
    let _e229 = f0_;
    let _e230 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e227, v_2, _e228, metallic_10, a_2, _e229);
    let _e231 = color;
    ...
    let _e258 = f0_;
    let _e261 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e254, in_1.worldPos, _e256, v_2, _e257, metallic_10, a_2, _e258, false, true);
    color = (_e251 + _e261);
    let _e263 = color;
