...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e55) * _e57), albedo, metallic_10);
    physicalNormal = n_2;
    diffuseAlbedo = albedo;
    let _e65 = physicalNormal;
    let _e69 = f0_;
    let _e70 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e65, v_2), 0f), _e69, iblRoughness);
    let kD = ((vec3(1f) - _e70) * (1f - metallic_10));
    ...
    if (_e82 < 0f) {
        ...
        let _e141 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e93, v_2, iblRoughness, _e94, in_2.worldPos, vec3<f32>(_e98, _e101, _e104), _e108.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1, skylightPrefilterMap, _e117, _e120.xyz, max((-(_e124) - 1f), 0f), (_e133 > 0.5f));
        specularIbl = _e141;
    } else {
        ...
        let _e159 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e150, v_2, iblRoughness, _e151, _e154, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e159;
    }
    ...
    let _e226 = f0_;
    let _e227 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e224, v_2, _e225, metallic_10, a_2, _e226);
    let _e228 = color;
    ...
    let _e255 = f0_;
    let _e258 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e251, in_2.worldPos, _e253, v_2, _e254, metallic_10, a_2, _e255, false, true);
    color = (_e248 + _e258);
    let _e260 = color;
