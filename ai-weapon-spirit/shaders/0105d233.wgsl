...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e220 = f0_;
    let _e221 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e218, v_2, _e219, metallic_13, a_3, _e220);
    let _e222 = color;
    ...
    let _e249 = f0_;
    let _e252 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e245, in_1.worldPos, _e247, v_2, _e248, metallic_13, a_3, _e249, false, true);
    color = (_e242 + _e252);
    let _e254 = color;
