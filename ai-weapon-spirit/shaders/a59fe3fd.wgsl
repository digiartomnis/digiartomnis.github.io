...
fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_9: vec3<f32>, lightColor_1: vec3<f32>, axisX_1: vec3<f32>, axisY_1: vec3<f32>, halfWidth_1: f32, halfHeight_1: f32, invRangeSquared_10: f32, worldPos_10: vec3<f32>, n_1: vec3<f32>, v_1: vec3<f32>, baseColor_7: vec3<f32>, metallic_5: f32, alphaSq_5: f32, F0_10: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_9, lightColor_1, axisX_1, axisY_1, halfWidth_1, halfHeight_1, invRangeSquared_10, worldPos_10, n_1, v_1, baseColor_7, metallic_5, alphaSq_5, F0_10);
    return _e14;
}
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_8: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_6: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_6, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e110 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_6, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            let _e116 = tile;
        ...
        let _e136 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_6, alpha_sq, f0_2);
        return (_e136 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e154 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_6, alpha_sq, f0_2);
        return _e154;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_2: vec3<f32>, normal_9: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_7: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool, receive_shadows_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e70 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_2, normal_9, view_dir_1, base_color_1, metallic_7, alpha_sq_1, f0_3, flat_2d_1, receive_shadows_1);
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_10: vec3<f32>, viewDir_4: vec3<f32>, baseColor_8: vec3<f32>, metallic_8: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    ...
    let nDotV_3 = max(dot(normal_10, viewDir_4), 0.00001f);
    ...
    let diffuse_1 = (((1f - metallic_8) * baseColor_8) / vec3(3.1415927f));
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4: u32, normal_11: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    ...
    let slope = ((abs(dot(normal_11, right)) + abs(dot(normal_11, up))) / nDotL_6);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_11: vec3<f32>, layer_5: u32, count_4: u32, normal_12: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_14: bool;
    var local_15: bool;
    var local_16: bool;
    var local_17: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12: vec3<f32>, layer_6: u32, count_5: u32, normal_13: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_26: bool;
    var local_27: bool;
    var local_28: bool;
    var local_29: bool;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12, layer_6, count_5, normal_13, l_2, filterProfile);
        return _e90;
    }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_14: vec3<f32>, worldPos_13: vec3<f32>, viewZ: f32) -> f32 {
    ...
    let receiverPosition = (worldPos_13 + (normal_14 * _e33));
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_32 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_32 = false;
    }
    let _e10 = local_32;
    if _e10 {
        local_33 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_33 = false;
    }
    let _e17 = local_33;
    if _e17 {
        local_34 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_34 = false;
    }
    let validReceiver = local_34;
    ...
    if all((uv_7 >= vec2(0f))) {
        local_35 = all((uv_7 <= vec2(1f)));
    } else {
        local_35 = false;
    }
    let inRange = local_35;
    if (shadowProjection.y > 0.5f) {
        local_36 = (shadowProjection.z < 0.5f);
    } else {
        local_36 = false;
    }
    let _e64 = local_36;
    if _e64 {
        local_37 = (shadowProjection.x > 0f);
    } else {
        local_37 = false;
    }
    let available = local_37;
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e155 = f0_;
    let _e156 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e151, v_2), 0f), _e155, iblRoughness);
    ...
    if (_e168 < 0f) {
        ...
        let _e227 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e179, v_2, iblRoughness, _e180, in_2.worldPos, vec3<f32>(_e184, _e187, _e190), _e194.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1, skylightPrefilterMap, _e203, _e206.xyz, max((-(_e210) - 1f), 0f), (_e219 > 0.5f));
        specularIbl = _e227;
    } else {
        ...
        let _e245 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e236, v_2, iblRoughness, _e237, _e240, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e245;
    }
    ...
    let _e492 = f0_;
    let _e493 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e490, v_2, _e491, metallic_10, a_2, _e492);
    let _e494 = color;
    ...
    let _e521 = f0_;
    let _e524 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e517, in_2.worldPos, _e519, v_2, _e520, metallic_10, a_2, _e521, false, true);
    color = (_e514 + _e524);
    let _e526 = color;
