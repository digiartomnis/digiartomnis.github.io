...
fn vs_main_impl(in_5: VsIn, meshIndex: u32, instanceIndex: u32, paletteBase: u32, materialIndex: u32, materialAddress: vec3<u32>) -> VsOut {
    ...
    out_2.positionOSAndViewZ = vec4<f32>(in_5.pos, _e75);
...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e72 = f0_;
    let _e73 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e68, v_5), 0f), _e72, iblRoughness);
    ...
    if (_e85 < 0f) {
        ...
        let _e91 = skylight.diffuseRotation;
        let _e94 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e88, _e91, irradianceMap_1, irradianceSampler_1);
        irradiance = _e94;
        let _e96 = physicalNormal;
        let _e97 = f0_;
        let _e101 = skylight.colorR;
        let _e104 = skylight.colorG;
        let _e107 = skylight.colorB;
        let _e111 = skylight.rotation;
        let _e120 = skylight.diffuseRotation;
        let _e123 = skylight.diffuseScale;
        let _e127 = skylight.intensity;
        let _e136 = skylight.rotation.w;
        let _e144 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e96, v_5, iblRoughness, _e97, in_1.worldPos, vec3<f32>(_e101, _e104, _e107), _e111.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1, skylightPrefilterMap, _e120, _e123.xyz, max((-(_e127) - 1f), 0f), (_e136 > 0.5f));
        specularIbl = _e144;
    } else {
        let _e146 = physicalNormal;
        let _e149 = skylight.rotation;
        let _e152 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e146, _e149, irradianceMap_1, irradianceSampler_1);
        irradiance = _e152;
        let _e153 = physicalNormal;
        let _e154 = f0_;
        let _e157 = skylight.rotation;
        let _e162 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e153, v_5, iblRoughness, _e154, _e157, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e162;
    }
    let ao = _e6.occlusion;
    let _e166 = skylight.colorR;
    let _e169 = skylight.colorG;
    let _e172 = skylight.colorB;
    let skyColor_1 = vec3<f32>(_e166, _e169, _e172);
    let _e176 = skylight.intensity;
    let _e180 = skylight.diffuseScale;
    let _e184 = skylight.intensity;
    let skyFactor = select((skyColor_1 * _e176), _e180.xyz, (_e184 < 0f));
    let _e190 = skylight.intensity;
    let _e191 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(skyColor_1, _e190);
    let _e192 = irradiance;
    let _e194 = diffuseAlbedo;
    let _e197 = specularIbl;
    let _e203 = coatF;
    ambient = (((((kD * _e192) * _e194) * skyFactor) + (_e197 * _e191)) * (vec3(1f) - _e203));
    let _e207 = ambient;
    ambient = (_e207 * ao);
    let _e209 = ambient;
    let _e213 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e216 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.worldPos, _e213, ssaoBlurredTexture, ssaoBlurredSampler);
    ambient = (_e209 * _e216);
    let _e218 = ambient;
    color = _e218;
    let _e220 = color;
    color = (_e220 + _e6.emissive);
    let _e223 = physicalNormal;
    let _e225 = standardViewZ(in_1);
    let _e226 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e223, in_1.worldPos, _e225);
    let _e227 = physicalNormal;
    let _e228 = diffuseAlbedo;
    let _e229 = f0_;
    let _e230 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e227, v_5, _e228, metallic_11, a_3, _e229);
    let _e231 = color;
    let _e236 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e240 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e244 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e248 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e249 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e226 * _e230), in_1.worldPos, _e236.xyz, _e240.xyz, _e244.xyz, _e248);
    color = (_e231 + _e249);
    let _e251 = color;
    let _e254 = standardViewZ(in_1);
    let _e256 = physicalNormal;
    let _e257 = diffuseAlbedo;
    let _e258 = f0_;
    let _e261 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e254, in_1.worldPos, _e256, v_5, _e257, metallic_11, a_3, _e258, false, true);
    color = (_e251 + _e261);
    let _e263 = color;
    return vec4<f32>(_e263, alpha);
}
