...
fn sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(normal_5: vec3<f32>, view_2: vec3<f32>, roughness_3: f32, F0_3: vec3<f32>, worldPosition_1: vec3<f32>, boxCenter_1: vec3<f32>, boxExtents_1: vec3<f32>, rotation_3: vec4<f32>, probeMap: texture_cube<f32>, probeSampler: sampler, brdfLut_2: texture_2d<f32>, brdfLutSampler_2: sampler, skylightMap: texture_cube<f32>, skylightRotation: vec4<f32>, skylightScale: vec3<f32>, probeIntensity: f32, boxProjection: bool) -> vec3<f32> {
    ...
    let local_41 = (_e55 * probeIntensity);
    let _e58 = sky;
    return mix(_e58, local_41, weight);
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let metallic_13 = clamp(_e14, 0f, 1f);
    ...
    let _e55 = f0_;
    let _e56 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e51, v_2), 0f), _e55, iblRoughness);
    let kD_1 = ((vec3(1f) - _e56) * (1f - metallic_13));
    ...
    if (_e68 < 0f) {
        ...
        let _e145 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e136, v_2, iblRoughness, _e137, _e140, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e145;
    }
    ...
    let _e314 = f0_;
    let _e315 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e312, v_2, _e313, metallic_13, a_3, _e314);
    let _e316 = color;
    ...
    let _e343 = f0_;
    let _e346 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e339, in_2.worldPos, _e341, v_2, _e342, metallic_13, a_3, _e343, false, true);
    color = (_e336 + _e346);
    let _e348 = color;
