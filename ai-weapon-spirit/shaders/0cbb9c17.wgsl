...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e205 = standardViewZ(in_1);
    let _e206 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e203, in_1.worldPos, _e205);
    let _e207 = physicalNormal;
    let _e208 = diffuseAlbedo;
    let _e209 = f0_;
    let _e210 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e207, v, _e208, metallic_5, a_3, _e209);
    let _e211 = color;
    let _e216 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e220 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e224 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e228 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e229 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e206 * _e210), in_1.worldPos, _e216.xyz, _e220.xyz, _e224.xyz, _e228);
    color = (_e211 + _e229);
    let _e231 = color;
    color = (_e231 + _e6.emissive);
    let _e236 = color;
    output.color = vec4<f32>(_e236, alpha_1);
    let _e239 = reflectionFallback;
    let _e240 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e239, _e240);
    let _e242 = output;
    return _e242;
}
