...
@group(1) @binding(47) 
var skylightPrefilterMap: texture_cube<f32>;
@group(1) @binding(46) 
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_2: vec3<f32>, normal_4: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic: f32, alphaSq: f32, F0_5: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_3 = max(dot(normal_4, l_3), 0f);
...
fn evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2: vec3<f32>, colorTimesIntensity_1: vec3<f32>, invRangeSquared_3: f32, worldPos_3: vec3<f32>, normal_5: vec3<f32>, viewDir_1: vec3<f32>, baseColor_1: vec3<f32>, metallic_1: f32, alphaSq_1: f32, F0_6: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2, colorTimesIntensity_1, invRangeSquared_3, worldPos_3, normal_5, viewDir_1, baseColor_1, metallic_1, alphaSq_1, F0_6);
    return _e10;
}
...
fn evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5: vec3<f32>, lightDir_2: vec3<f32>, colorTimesIntensity_4: vec3<f32>, cosInner_2: f32, cosOuter_2: f32, invRangeSquared_7: f32, worldPos_6: vec3<f32>, normal_6: vec3<f32>, viewDir_2: vec3<f32>, baseColor_4: vec3<f32>, metallic_2: f32, alphaSq_2: f32, F0_7: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5, colorTimesIntensity_4, invRangeSquared_7, worldPos_6, normal_6, viewDir_2, baseColor_4, metallic_2, alphaSq_2, F0_7);
...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_5: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_8: f32, worldPos_7: vec3<f32>, normal_7: vec3<f32>, viewDir_3: vec3<f32>, baseColor_5: vec3<f32>, metallic_3: f32, alphaSq_3: f32, F0_8: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_1: f32, normalBias_1: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    var local_4: bool;
    var local_5: bool;
    var local_6: bool;
    var local_7: bool;

    let _e13 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6, lightDir_3, colorTimesIntensity_5, cosInner_3, cosOuter_3, invRangeSquared_8, worldPos_7, normal_7, viewDir_3, baseColor_5, metallic_3, alphaSq_3, F0_8);
    ...
    let nDotL_4 = max(dot(normal_7, normalize((lightPos_6 - worldPos_7))), 0f);
...
fn evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_10: vec3<f32>, lightColor: vec3<f32>, axisX_1: vec3<f32>, axisY_1: vec3<f32>, halfWidth_1: f32, halfHeight_1: f32, invRangeSquared_10: f32, worldPos_11: vec3<f32>, n_2: vec3<f32>, v_2: vec3<f32>, baseColor_6: vec3<f32>, metallic_4: f32, alphaSq_4: f32, F0_9: vec3<f32>) -> vec3<f32> {
    ...
    let diffuse_1 = (baseColor_6 * (1f - metallic_4));
...
fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11: vec3<f32>, lightColor_1: vec3<f32>, axisX_2: vec3<f32>, axisY_2: vec3<f32>, halfWidth_2: f32, halfHeight_2: f32, invRangeSquared_11: f32, worldPos_12: vec3<f32>, n_3: vec3<f32>, v_3: vec3<f32>, baseColor_7: vec3<f32>, metallic_5: f32, alphaSq_5: f32, F0_10: vec3<f32>) -> vec3<f32> {
    ...
    let _e48 = evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11, lightColor_1, axisX_2, axisY_2, halfWidth_2, halfHeight_2, invRangeSquared_11, worldPos_12, n_3, v_3, baseColor_7, metallic_5, alphaSq_5, F0_10);
...
fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12: vec3<f32>, lightColor_2: vec3<f32>, axisX_3: vec3<f32>, axisY_3: vec3<f32>, halfWidth_3: f32, halfHeight_3: f32, invRangeSquared_12: f32, worldPos_13: vec3<f32>, n_4: vec3<f32>, v_4: vec3<f32>, baseColor_8: vec3<f32>, metallic_6: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12, lightColor_2, axisX_3, axisY_3, halfWidth_3, halfHeight_3, invRangeSquared_12, worldPos_13, n_4, v_4, baseColor_8, metallic_6, alphaSq_6, F0_11);
    return _e14;
}
...
fn sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(worldPosition_2: vec3<f32>, worldViewProjection: mat4x4<f32>, aoTexture: texture_2d<f32>, aoSampler: sampler) -> f32 {
    ...
    let clip_4 = (worldViewProjection * vec4<f32>(worldPosition_2, 1f));
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_8: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_7: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_7, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e110 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_7, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            let _e116 = tile;
        ...
        let _e136 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_7, alpha_sq, f0_2);
        return (_e136 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e154 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_8, view_dir, base_color, metallic_7, alpha_sq, f0_2);
        return _e154;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_2: vec3<f32>, normal_9: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_8: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool, receive_shadows_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e70 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_2, normal_9, view_dir_1, base_color_1, metallic_8, alpha_sq_1, f0_3, flat_2d_1, receive_shadows_1);
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_10: vec3<f32>, viewDir_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_9: f32, alphaSq_7: f32, F0_12: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_5 = max(dot(normal_10, l_6), 0f);
    let nDotV_4 = max(dot(normal_10, viewDir_4), 0.00001f);
    ...
    let diffuse_2 = (((1f - metallic_9) * baseColor_9) / vec3(3.1415927f));
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4: u32, normal_11: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    var local_18: bool;

    let nDotL_6 = dot(normal_11, l);
    ...
    let slope = ((abs(dot(normal_11, right_1)) + abs(dot(normal_11, up_1))) / nDotL_6);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_14: vec3<f32>, layer_5: u32, count_4: u32, normal_12: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_19: bool;
    var local_20: bool;
    var local_21: bool;
    var local_22: bool;
    ...
    let _e118 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5, normal_12, l_1, (rawRadius + 1f));
    ...
    let _e258 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5, normal_12, l_1, (compareRadius + 1.5f));
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15: vec3<f32>, layer_6: u32, count_5: u32, normal_13: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_31: bool;
    var local_32: bool;
    var local_33: bool;
    var local_34: bool;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15, layer_6, count_5, normal_13, l_2, filterProfile);
        return _e90;
    }
    let kernel = select(select(3u, 5u, (filterProfile == 3u)), 1u, (filterProfile == 1u));
    let _e105 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_6, normal_13, l_2, f32(((kernel / 2u) + 1u)));
    ...
    if (kernel == 3u) {
        if all((uv_6 >= (tileLo + texel_5))) {
            local_35 = all((uv_6 <= (tileHi - texel_5)));
        } else {
            local_35 = false;
        }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_14: vec3<f32>, worldPos_16: vec3<f32>, viewZ: f32) -> f32 {
    ...
    let receiverPosition = (worldPos_16 + (normal_14 * _e33));
    let _e36 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, _e28, count_6, normal_14, l_7);
    shadow_1 = _e36;
    ...
    if _e49 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e72 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, (_e28 + 1u), count_6, normal_14, l_7);
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_37 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_37 = false;
    }
    let _e10 = local_37;
    if _e10 {
        local_38 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_38 = false;
    }
    let _e17 = local_38;
    if _e17 {
        local_39 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_39 = false;
    }
    let validReceiver = local_39;
    ...
    if all((uv_7 >= vec2(0f))) {
        local_40 = all((uv_7 <= vec2(1f)));
    } else {
        local_40 = false;
    }
    let inRange = local_40;
    if (shadowProjection.y > 0.5f) {
        local_41 = (shadowProjection.z < 0.5f);
    } else {
        local_41 = false;
    }
    let _e64 = local_41;
    if _e64 {
        local_42 = (shadowProjection.x > 0f);
    } else {
        local_42 = false;
    }
    let available = local_42;
...
fn vs_main_impl(in_6: VsIn, meshIndex: u32, instanceIndex: u32, paletteBase: u32, materialIndex_1: u32, materialAddress: vec3<u32>) -> VsOut {
    ...
    out_2.materialAddress = materialAddress;
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e155 = f0_;
    let _e156 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(_e151, v_5), 0f), _e155, iblRoughness);
    ...
    if (_e168 < 0f) {
        ...
        let _e174 = skylight.diffuseRotation;
        let _e177 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e171, _e174, irradianceMap_1, irradianceSampler_1);
        irradiance = _e177;
        let _e179 = physicalNormal;
        let _e180 = f0_;
        let _e184 = skylight.colorR;
        let _e187 = skylight.colorG;
        let _e190 = skylight.colorB;
        let _e194 = skylight.rotation;
        let _e203 = skylight.diffuseRotation;
        let _e206 = skylight.diffuseScale;
        let _e210 = skylight.intensity;
        let _e219 = skylight.rotation.w;
        let _e227 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e179, v_5, iblRoughness, _e180, in_2.worldPos, vec3<f32>(_e184, _e187, _e190), _e194.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1, skylightPrefilterMap, _e203, _e206.xyz, max((-(_e210) - 1f), 0f), (_e219 > 0.5f));
        specularIbl = _e227;
    } else {
        let _e229 = physicalNormal;
        let _e232 = skylight.rotation;
        let _e235 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e229, _e232, irradianceMap_1, irradianceSampler_1);
        irradiance = _e235;
        let _e236 = physicalNormal;
        let _e237 = f0_;
        let _e240 = skylight.rotation;
        let _e245 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e236, v_5, iblRoughness, _e237, _e240, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specularIbl = _e245;
    }
    let ao = _e7.occlusion;
    let _e249 = skylight.colorR;
    let _e252 = skylight.colorG;
    let _e255 = skylight.colorB;
    let skyColor_1 = vec3<f32>(_e249, _e252, _e255);
    let _e259 = skylight.intensity;
    let _e263 = skylight.diffuseScale;
    let _e267 = skylight.intensity;
    let skyFactor = select((skyColor_1 * _e259), _e263.xyz, (_e267 < 0f));
    let _e273 = skylight.intensity;
    let _e274 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(skyColor_1, _e273);
    let _e275 = irradiance;
    let _e277 = diffuseAlbedo;
    let _e280 = specularIbl;
    let _e286 = coatF;
    ambient = (((((kD * _e275) * _e277) * skyFactor) + (_e280 * _e274)) * (vec3(1f) - _e286));
    let _e290 = ambient;
    ambient = (_e290 * ao);
    let _e292 = ambient;
    let _e296 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e299 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.worldPos, _e296, ssaoBlurredTexture, ssaoBlurredSampler);
    ambient = (_e292 * _e299);
    let _e301 = ambient;
    color = _e301;
    ...
    let _e374 = material.thickness;
    let _e376 = finiteScalar(_e374, 0f);
    let _e379 = thicknessSample;
    let _e381 = finiteScalar(_e379, 1f);
    let worldThickness = max(((_e376 * length(worldRefractedDirection)) * _e381), 0f);
    ...
    let _e423 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e423.xyz;
    ...
    let _e431 = local_1;
    if _e431 {
        let _e439 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e439.xyz;
    }
    let _e443 = material.attenuationColor;
    let _e446 = finiteColor(_e443, vec3(1f));
    let safeAttenuationColor = clamp(_e446, vec3(0f), vec3(1f));
    let _e454 = material.attenuationDistance;
    let _e456 = finiteScalar(_e454, 0f);
    let safeAttenuationDistance = max(_e456, 0f);
    ...
    let _e473 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e473);
    let _e475 = color;
    let _e476 = transmittedBackdrop;
    let _e479 = finiteColor(_e476, vec3(0f));
    color = (_e475 + ((_e479 * transmittedEnergy) * beerAttenuation));
    let _e483 = color;
    color = (_e483 + _e7.emissive);
    let _e486 = physicalNormal;
    let _e488 = standardViewZ(in_2);
    let _e489 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e486, in_2.worldPos, _e488);
    let _e490 = physicalNormal;
    let _e491 = diffuseAlbedo;
    let _e492 = f0_;
    let _e493 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e490, v_5, _e491, metallic_11, a_3, _e492);
    let _e494 = color;
    let _e499 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e503 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e507 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e511 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e512 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e489 * _e493), in_2.worldPos, _e499.xyz, _e503.xyz, _e507.xyz, _e511);
    color = (_e494 + _e512);
    let _e514 = color;
    let _e517 = standardViewZ(in_2);
    let _e519 = physicalNormal;
    let _e520 = diffuseAlbedo;
    let _e521 = f0_;
    let _e524 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e517, in_2.worldPos, _e519, v_5, _e520, metallic_11, a_3, _e521, false, true);
    color = (_e514 + _e524);
    let _e526 = color;
    return vec4<f32>(_e526, alpha);
}
