...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e221 = f0_;
    let _e222 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e219, v_2, _e220, metallic_13, a_3, _e221);
    let _e223 = color;
    ...
    let _e250 = f0_;
    let _e253 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e246, in_2.worldPos, _e248, v_2, _e249, metallic_13, a_3, _e250, false, true);
    color = (_e243 + _e253);
    let _e255 = color;
