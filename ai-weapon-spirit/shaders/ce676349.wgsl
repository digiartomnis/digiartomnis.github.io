...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e197 = ambient;
    ambient = (_e197 * ao);
    let _e199 = reflectionFallback;
    reflectionFallback = ((_e199 * _e174) * ao);
    let _e205 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e208 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.worldPos, _e205, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e209 = ambient;
    ambient = (_e209 * _e208);
    let _e211 = reflectionFallback;
    reflectionFallback = (_e211 * _e208);
    let _e213 = ambient;
    color = _e213;
    let _e215 = physicalNormal;
    let _e217 = standardViewZ(in_2);
    let _e218 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e215, in_2.worldPos, _e217);
    let _e219 = physicalNormal;
    let _e220 = diffuseAlbedo;
    let _e221 = f0_;
    let _e222 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e219, v_5, _e220, metallic_14, a_4, _e221);
    let _e223 = color;
    let _e228 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e232 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e236 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e240 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e241 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((_e218 * _e222), in_2.worldPos, _e228.xyz, _e232.xyz, _e236.xyz, _e240);
    color = (_e223 + _e241);
    let _e243 = color;
    let _e246 = standardViewZ(in_2);
    let _e248 = physicalNormal;
    let _e249 = diffuseAlbedo;
    let _e250 = f0_;
    let _e253 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e246, in_2.worldPos, _e248, v_5, _e249, metallic_14, a_4, _e250, false, true);
    color = (_e243 + _e253);
    let _e255 = color;
    color = (_e255 + _e9.emissive);
    let _e260 = color;
    output.color = vec4<f32>(_e260, alpha_1);
    let _e263 = reflectionFallback;
    let _e264 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e263, _e264);
    let _e266 = output;
    return _e266;
}
