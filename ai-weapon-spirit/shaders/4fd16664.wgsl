...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e269 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e265, (_e266 * skyFactor), probeDiffuseK, _e268, metallic_4);
    if true {
    ...
    let _e292 = f0_;
    let _e293 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e290, v, _e291, metallic_4, a_2, _e292);
    let _e294 = color;
