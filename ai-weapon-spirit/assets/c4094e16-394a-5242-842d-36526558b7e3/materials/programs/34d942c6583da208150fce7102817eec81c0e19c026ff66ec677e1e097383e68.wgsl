...
fn vs_main(native: NativeInput, @builtin(vertex_index) vertex: u32) -> Varying {
    ...
    let _e285 = world;
    let _e287 = input.objectPosition;
    let _e288 = input;
    let _e289 = source_vertex(_e288);
    let _e290 = right;
    let _e291 = up;
    let _e296 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.settings.w;
    let _e297 = magic_apply_object_vertexX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e285, _e287, _e289, mat3x3<f32>(_e290, _e291, normal), _e296);
    let _e299 = p.age;
    let _e300 = magic_placeX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e297, _e299);
    let _e303 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.anchor;
    world = (_e300 + _e303.xyz);
    let _e310 = frame.vp;
    let _e311 = world;
    o.position = (_e310 * vec4<f32>(_e311, 1f));
    o.uv = _e186.uv0_;
    o.custom = _e186.uv1_;
    ...
    let _e327 = world;
    o.world = _e327;
    let _e331 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e335 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e339 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.normal = normalize((mat3x3<f32>(_e331.xyz, _e335.xyz, _e339.xyz) * normal));
    let _e347 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e351 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e355 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.tangent = normalize((mat3x3<f32>(_e347.xyz, _e351.xyz, _e355.xyz) * tangent));
    o.object = _e205;
