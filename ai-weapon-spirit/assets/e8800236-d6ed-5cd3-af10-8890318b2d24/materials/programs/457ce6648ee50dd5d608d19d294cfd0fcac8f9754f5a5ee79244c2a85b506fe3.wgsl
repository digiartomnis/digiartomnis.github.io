...
fn paintedRimX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU4DBNFXHIZLSNR4V643VOJTGCY3FX(normal_4: vec3<f32>, camera_1: vec3<f32>, roughness_3: f32, strength_1: f32, visibility_2: f32) -> f32 {
    let fresnel_1 = pow((1f - clamp(dot(normal_4, camera_1), 0f, 1f)), 4f);
...
fn shadeTitleX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX(input_2: TitleVaryingsX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX, frontFacing_1: bool) -> vec4<f32> {
    ...
    normal_5 = normalize(input_2.worldNormal);
    if !(frontFacing_1) {
        let _e6 = normal_5;
        normal_5 = -(_e6);
    }
...
fn titleNormalX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX(model: mat4x4<f32>, normal_6: vec3<f32>) -> vec3<f32> {
    let a_2 = model[0].xyz;
    let b = model[1].xyz;
    let c = model[2].xyz;
    return normalize((mat3x3<f32>(cross(b, c), cross(c, a_2), cross(a_2, b)) * normal_6));
}
