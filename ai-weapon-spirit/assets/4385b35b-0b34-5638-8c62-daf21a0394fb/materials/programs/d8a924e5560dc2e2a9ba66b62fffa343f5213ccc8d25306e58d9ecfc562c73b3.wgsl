...
fn magic_apply_object_vertexX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(assembled: vec3<f32>, original: vec3<f32>, modified: vec3<f32>, axes: mat3x3<f32>, size_1: f32) -> vec3<f32> {
    return (assembled + ((axes * (modified - original)) * size_1));
}
...
fn vs_main(native: NativeInput, @builtin(vertex_index) vertex: u32) -> Varying {
    ...
    let _e592 = world;
    let _e594 = input.objectPosition;
    let _e595 = input;
    let _e596 = source_vertex(_e595);
    let _e597 = right;
    let _e598 = up;
    let _e603 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.settings.w;
    let _e604 = magic_apply_object_vertexX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e592, _e594, _e596, mat3x3<f32>(_e597, _e598, normal), _e603);
    let _e606 = p.age;
    let _e607 = magic_placeX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e604, _e606);
    let _e610 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.anchor;
    world = (_e607 + _e610.xyz);
    let _e617 = frame.vp;
    let _e618 = world;
    o.position = (_e617 * vec4<f32>(_e618, 1f));
    o.uv = _e184.uv0_;
    o.custom = _e184.uv1_;
    ...
    let _e634 = world;
    o.world = _e634;
    let _e638 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e642 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e646 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.normal = normalize((mat3x3<f32>(_e638.xyz, _e642.xyz, _e646.xyz) * normal));
    let _e654 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e658 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e662 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.tangent = normalize((mat3x3<f32>(_e654.xyz, _e658.xyz, _e662.xyz) * tangent));
    o.object = _e203;
    o.objectNormal = objectNormal;
    let _e671 = p.id;
    let _e680 = frame.extra.x;
    let _e683 = p.id;
    let _e685 = dm_random(bitcast<u32>(_e680), _e683, 390u);
    o.bolt = vec4<f32>(_e79, (f32((_e671 % 3u)) - 1f), _e685);
    let _e687 = o;
    return _e687;
}
