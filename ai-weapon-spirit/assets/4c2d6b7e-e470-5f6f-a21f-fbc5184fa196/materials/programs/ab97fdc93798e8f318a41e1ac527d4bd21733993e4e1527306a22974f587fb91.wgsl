...
fn vs_main(native: NativeInput, @builtin(vertex_index) vertex: u32) -> Varying {
    ...
    let _e445 = world;
    let _e447 = input.objectPosition;
    let _e448 = input;
    let _e449 = source_vertex(_e448);
    let _e450 = right;
    let _e451 = up;
    let _e456 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.settings.w;
    let _e457 = magic_apply_object_vertexX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e445, _e447, _e449, mat3x3<f32>(_e450, _e451, normal), _e456);
    let _e459 = p.age;
    let _e460 = magic_placeX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX(_e457, _e459);
    let _e463 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.anchor;
    world = (_e460 + _e463.xyz);
    let _e470 = frame.vp;
    let _e471 = world;
    o.position = (_e470 * vec4<f32>(_e471, 1f));
    o.uv = _e203.uv0_;
    o.custom = _e203.uv1_;
    ...
    let _e487 = world;
    o.world = _e487;
    let _e491 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e495 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e499 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.normal = normalize((mat3x3<f32>(_e491.xyz, _e495.xyz, _e499.xyz) * normal));
    let _e507 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e511 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e515 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.tangent = normalize((mat3x3<f32>(_e507.xyz, _e511.xyz, _e515.xyz) * tangent));
    o.object = _e222;
