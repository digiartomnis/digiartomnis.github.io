...
fn gradient_6_(t_4: f32) -> vec4<f32> {
    ...
    if (t_4 <= 0.33530176f) {
        ...
        if (t_4 <= 1f) {
            rgb_2 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 0.1102941f, 0.1102941f), ((t_4 - 0.33530176f) / 0.66469824f));
        }
    }
    if (t_4 <= 0f) {
        alpha_1 = 0f;
        ...
        if (t_4 <= 0.15294118f) {
            alpha_1 = mix(0f, 1f, ((t_4 - 0f) / 0.15294118f));
        } else {
            if (t_4 <= 0.32646677f) {
                alpha_1 = mix(1f, 0.3215686f, ((t_4 - 0.15294118f) / 0.1735256f));
            } else {
                if (t_4 <= 1f) {
                    alpha_1 = mix(0.3215686f, 0f, ((t_4 - 0.32646677f) / 0.6735332f));
                }
            }
        }
    }
...
fn gradient_7_(t_5: f32) -> vec4<f32> {
    ...
    if (t_5 <= 0.33530176f) {
        ...
        if (t_5 <= 1f) {
            rgb_3 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 0.1102941f, 0.1102941f), ((t_5 - 0.33530176f) / 0.66469824f));
        }
    }
    if (t_5 <= 0f) {
        alpha_2 = 0f;
        ...
        if (t_5 <= 0.1882353f) {
            alpha_2 = mix(0f, 1f, ((t_5 - 0f) / 0.1882353f));
        } else {
            if (t_5 <= 1f) {
                alpha_2 = mix(1f, 0f, ((t_5 - 0.1882353f) / 0.8117647f));
            }
        }
    }
    let _e49 = rgb_3;
...
fn dm_appearance(seed_1: u32, id_1: u32, t_6: f32, particle: ptr<function, Particle>) {
    ...
    let _e56 = gradient_6_(t_6);
    let _e57 = gradient_7_(t_6);
    let _e59 = dm_random(seed_1, id_1, 7u);
    (*particle).color = (mix(vec4<f32>(0.7264151f, 0f, 0.1659487f, 1f), vec4<f32>(1f, 0f, 0f, 1f), _e54) * mix(_e56, _e57, _e59));
    let _e65 = dm_random(seed_1, id_1, 61u);
...
fn curve_4_(t_7: f32) -> f32 {
    ...
    if (t_7 < 1f) {
        let u_7 = ((t_7 - 0.1688984f) / 0.8311016f);
